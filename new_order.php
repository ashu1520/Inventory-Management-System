...
<div class="overlay"><div class="loader"></div></div>
	...
	<style>
			body {
			  background-image: url('./images/neworderback.jpg');
	...
	<div class="container">
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
                    ...
                    <center>
                      <input type="submit" id="order_form" style="width:150px;background-color:black;color:white;" class="btn btn-info" value="Order">
